...
'                    </div>',
'                  </sc-if>',
'                  <sc-if value="{{ gambleShow }}" hint-placeholder-val="{{ true }}">',
'                    <div style="{{ gambleBoxStyle }}">',
'                      <div style="font:500 22px/1 ' + Q + 'C11' + Q + ';color:#E9B341;margin-bottom:7px">{{ gambleTitle }}</div>',
'                      <div style="font:400 22px/1.65 ' + Q + 'C11' + Q + ';color:#C3BAAA;margin-bottom:9px;max-width:520px;text-wrap:pretty">{{ gambleBody }}</div>',
'                      <div style="font:400 11px/1.7 ' + Q + 'C11' + Q + ';color:#6E665A;margin-bottom:13px;max-width:520px;text-wrap:pretty">{{ gambleCost }}</div>',
'                      <div style="display:flex;flex-direction:column;gap:7px">',
'                        <sc-for list="{{ gambleItems }}" as="gb" hint-placeholder-count="3">',
'                          <button onClick="{{ gb.pick }}" style="{{ gb.style }}">',
'                            {{ gb.label }}',
'                            <span style="{{ gb.textStyle }}">{{ gb.text }}</span>',
'                          </button>',
'                        </sc-for>',
'                      </div>',
'                    </div>',
...
/* 56. 地圖那一組分頁多一個「試挖」 */
t = t.split('<button onClick="{{ mapTabColl }}" style="{{ mapTabCollStyle }}">收藏總覽</button>')
     .join('<button onClick="{{ mapTabColl }}" style="{{ mapTabCollStyle }}">收藏總覽</button>' +
           '<sc-if value="{{ showDigTab }}" hint-placeholder-val="{{ true }}">' +
...
/* 57. 試挖那一整頁 */
must(
'          <sc-if value="{{ scColl }}" hint-placeholder-val="{{ false }}">',
[
'          <sc-if value="{{ scRec }}" hint-placeholder-val="{{ false }}">',
'            <div data-screen-label="S-11 任務紀錄" style="padding:0 0 32px">',
'              <div style="padding:22px var(--pad) 16px;border-bottom:1px solid #221E19">',
'                <div style="display:flex;gap:7px;flex-wrap:wrap;margin-bottom:14px">',
'                  <button onClick="{{ mapTabMap }}" style="{{ mapTabMapStyle }}">地圖剖面</button>',
'                  <button onClick="{{ mapTabColl }}" style="{{ mapTabCollStyle }}">收藏總覽</button>',
...
'                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(228px,1fr));gap:12px">',
'                  <sc-for list="{{ rateRows }}" as="rt" hint-placeholder-count="5">',
'                    <div>',
'                      <div style="{{ rt.nameStyle }}">{{ rt.name }}</div>',
'                      <div style="{{ rt.barStyle }}"><div style="{{ rt.fillStyle }}"></div></div>',
'                      <div style="{{ rt.txtStyle }}">{{ rt.txt }}</div>',
'                    </div>',
'                  </sc-for>',
'                </div>',
'              </div>',
...
'                <div style="display:flex;flex-direction:column;gap:8px">',
'                  <sc-for list="{{ recRows }}" as="rc" hint-placeholder-count="4">',
'                    <div style="{{ rc.boxStyle }}">',
'                      <div style="display:flex;flex-wrap:wrap;align-items:baseline;gap:10px">',
'                        <span style="{{ rc.titleStyle }}">{{ rc.title }}</span>',
'                        <span style="{{ rc.statStyle }}">{{ rc.stat }}</span>',
'                      </div>',
'                      <div style="{{ rc.metaStyle }}">{{ rc.meta }}</div>',
'                      <div style="{{ rc.vowStyle }}">{{ rc.vowTxt }}</div>',
'                      <div style="{{ rc.sayStyle }}">{{ rc.say }}</div>',
'                    </div>',
'                  </sc-for>',
'                </div>',
'              </div>',
...
'              </div>',
'              <div style="padding:18px var(--pad) 0">',
'                <div style="font:400 11px/1.7 ' + Q + 'C11' + Q + ';color:#6E665A;margin-bottom:14px;max-width:560px;text-wrap:pretty">{{ haulNote }}</div>',
'                <sc-if value="{{ hasClaims }}" hint-placeholder-val="{{ true }}">',
'                  <div style="margin-bottom:22px;padding:16px 18px;background:#14110E;border:1px solid #3A3026">',
'                    <div style="font:500 22px/1.3 ' + Q + 'C11' + Q + ';color:#E9B341;margin-bottom:5px">{{ claimHead }}</div>',
'                    <div style="font:400 11px/1.7 ' + Q + 'C11' + Q + ';color:#8A8073;margin-bottom:13px;max-width:520px;text-wrap:pretty">{{ claimNote }}</div>',
'                    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(210px,1fr));gap:6px">',
'                      <sc-for list="{{ claimRows }}" as="cl" hint-placeholder-count="6">',
'                        <div style="{{ cl.boxStyle }}">',
'                          <div style="display:flex;align-items:baseline;gap:9px">',
'                            <span style="{{ cl.nameStyle }}">{{ cl.name }}</span>',
'                            <span style="{{ cl.byStyle }}">{{ cl.by }}</span>',
'                          </div>',
'                          <div style="{{ cl.metaStyle }}">{{ cl.meta }}</div>',
'                        </div>',
'                      </sc-for>',
'                    </div>',
'                  </div>',
'                </sc-if>',
'                <div style="display:flex;flex-direction:column;gap:8px">',
'                  <sc-for list="{{ haulRows }}" as="hl" hint-placeholder-count="4">',
'                    <div style="{{ hl.rowStyle }}">',
'                      <div style="display:flex;align-items:baseline;gap:11px">',
'                        <span style="{{ hl.rankStyle }}">{{ hl.rank }}</span>',
'                        <span style="{{ hl.nameStyle }}">{{ hl.name }}</span>',
'                        <span style="{{ hl.totalStyle }}">{{ hl.total }}</span>',
'                      </div>',
'                      <div style="{{ hl.barStyle }}">',
'                        <div style="{{ hl.baseStyle }}"></div>',
'                        <div style="{{ hl.bonusStyle }}"></div>',
'                      </div>',
'                      <div style="{{ hl.detailStyle }}">{{ hl.detail }}</div>',
'                    </div>',
'                  </sc-for>',
'                </div>',
'              </div>',
'            </div>',
'          </sc-if>',
'          <sc-if value="{{ scDig }}" hint-placeholder-val="{{ false }}">',
'            <div data-screen-label="S-09 試挖" style="padding:0 0 32px">',
'              <div style="padding:22px var(--pad) 16px;border-bottom:1px solid #221E19">',
'                <div style="display:flex;gap:7px;flex-wrap:wrap;margin-bottom:14px">',
'                  <button onClick="{{ mapTabMap }}" style="{{ mapTabMapStyle }}">地圖剖面</button>',
'                  <button onClick="{{ mapTabColl }}" style="{{ mapTabCollStyle }}">收藏總覽</button>',
...
'                <h1 style="font:700 33px/1.4 ' + Q + 'C11' + Q + ';margin:10px 0 5px;letter-spacing:.04em">試挖</h1>',
'                <p style="font:400 22px/1.7 ' + Q + 'C11' + Q + ';color:#8A8073;margin:0;max-width:520px;text-wrap:pretty">想到一個方向就開一條岔路去試。不用等老師，也不影響過關。試出來不成立也留著——那是你試過的證據。</p>',
'              </div>',

'              <div style="margin:20px var(--pad) 0;padding:17px 19px;background:#14110E;border:1px solid #3A3026">',
'                <div style="font:400 11px/1 ' + Q + 'C11' + Q + ';letter-spacing:.18em;color:#E9B341;margin-bottom:11px">開一條</div>',
'                <input value="{{ digDraftText }}" onChange="{{ setDigText }}" placeholder="例：訪談對象改成大一新生" style="width:100%;padding:12px 13px;background:#0E0C0A;border:1px solid #2E2822;color:#E8E2D6;font:400 22px/1.6 ' + Q + 'C11' + Q + ';outline:none">',
'                <div style="display:flex;flex-wrap:wrap;align-items:center;gap:9px;margin-top:11px">',
'                  <span style="font:400 11px/1 ' + Q + 'C11' + Q + ';color:#8A8073">估幾天</span>',
'                  <input value="{{ digDraftDays }}" onChange="{{ setDigDays }}" placeholder="3" style="width:74px;padding:9px 11px;background:#0E0C0A;border:1px solid #2E2822;color:#E8E2D6;font:400 22px/1 ' + Q + 'C11' + Q + ';outline:none">',
'                  <span style="font:400 11px/1 ' + Q + 'C11' + Q + ';color:#8A8073;margin-left:6px">你覺得</span>',
'                  <sc-for list="{{ digBetPicks }}" as="bp" hint-placeholder-count="3">',
'                    <button onClick="{{ bp.pick }}" style="{{ bp.style }}">{{ bp.label }}</button>',
'                  </sc-for>',
'                </div>',
'                <button onClick="{{ openDig }}" style="margin-top:14px;font:500 22px/1 ' + Q + 'C11' + Q + ';letter-spacing:.16em;color:#0B0A09;background:#E9B341;border:none;padding:13px 22px;cursor:pointer;clip-path:polygon(9px 0,100% 0,100% calc(100% - 9px),calc(100% - 9px) 100%,0 100%,0 9px)">挖下去</button>',
'              </div>',

'              <div style="padding:20px var(--pad) 0">',
'                <div style="font:400 11px/1 ' + Q + 'C11' + Q + ';letter-spacing:.18em;color:#5F574C;margin-bottom:5px">還開著的</div>',
'                <div style="font:400 11px/1.7 ' + Q + 'C11' + Q + ';color:#8A8073;margin-bottom:11px">{{ digOpenNote }}</div>',
'                <div style="display:flex;flex-direction:column;gap:9px">',
'                  <sc-for list="{{ digOpen }}" as="dg" hint-placeholder-count="2">',
'                    <div style="{{ dg.boxStyle }}">',
'                      <div style="{{ dg.textStyle }}">{{ dg.text }}</div>',
'                      <div style="{{ dg.metaStyle }}">{{ dg.meta }}</div>',
'                      <div style="display:flex;flex-wrap:wrap;gap:7px;margin-top:10px">',
'                        <sc-for list="{{ dg.picks }}" as="pk" hint-placeholder-count="3">',
'                          <button onClick="{{ pk.pick }}" style="{{ pk.style }}">{{ pk.label }}</button>',
'                        </sc-for>',
'                      </div>',
'                    </div>',
'                  </sc-for>',
...
'              <sc-if value="{{ digCalibShow }}" hint-placeholder-val="{{ true }}">',
'                <div style="margin:22px var(--pad) 0;padding:17px 19px;background:#14110E;border:1px solid #3A3026">',
'                  <div style="font:400 11px/1 ' + Q + 'C11' + Q + ';letter-spacing:.18em;color:#E9B341;margin-bottom:4px">你的準度</div>',
'                  <div style="font:400 11px/1.7 ' + Q + 'C11' + Q + ';color:#6E665A;margin-bottom:15px;max-width:460px;text-wrap:pretty">試挖不給分。它只給你這兩個數字——押得準不準、估得準不準。</div>',
'                  <div style="display:flex;flex-wrap:wrap;gap:26px">',
'                    <sc-for list="{{ digGauges }}" as="gg" hint-placeholder-count="2">',
'                      <div style="flex:1 1 230px;min-width:0">',
'                        <div style="{{ gg.headStyle }}">{{ gg.head }}</div>',
'                        <div style="{{ gg.barStyle }}"><div style="{{ gg.fillStyle }}"></div></div>',
'                        <div style="{{ gg.subStyle }}">{{ gg.sub }}</div>',
'                      </div>',
'                    </sc-for>',
'                  </div>',
'                </div>',
'              </sc-if>',
'              <div style="padding:22px var(--pad) 0">',
'                <div style="font:400 11px/1 ' + Q + 'C11' + Q + ';letter-spacing:.18em;color:#5F574C;margin-bottom:5px">挖過的</div>',
'                <div style="font:400 11px/1.7 ' + Q + 'C11' + Q + ';color:#8A8073;margin-bottom:11px">{{ digDoneNote }}</div>',
'                <div style="display:flex;flex-direction:column;gap:7px">',
'                  <sc-for list="{{ digDone }}" as="dd" hint-placeholder-count="3">',
'                    <div style="{{ dd.boxStyle }}">',
'                      <div style="display:flex;align-items:flex-start;gap:10px">',
'                        <span style="{{ dd.tagStyle }}">{{ dd.tag }}</span>',
'                        <span style="{{ dd.textStyle }}">{{ dd.text }}</span>',
'                      </div>',
'                      <div style="{{ dd.metaStyle }}">{{ dd.meta }}</div>',
'                    </div>',
'                  </sc-for>',
'                </div>',
'              </div>',
...
'                    <span style="font:400 11px/1 ' + Q + 'C11' + Q + ';letter-spacing:.18em;color:#E9B341">圖鑑</span>',
'                    <span style="font:700 22px/1 ' + Q + 'C11' + Q + ';color:#E8E2D6">{{ bestCount }}</span>',
'                  </div>',
'                  <div style="font:400 11px/1.7 ' + Q + 'C11' + Q + ';color:#8A8073;margin-bottom:12px;max-width:520px;text-wrap:pretty">{{ bestNote }}</div>',
'                  <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(268px,1fr));gap:7px">',
'                    <sc-for list="{{ bestRows }}" as="bs" hint-placeholder-count="6">',
'                      <button onClick="{{ bs.open }}" style="{{ bs.boxStyle }}">',
'                        <span style="{{ bs.art }}"></span>',
'                        <span style="min-width:0;flex:1">',
'                          <span style="{{ bs.nameStyle }}">{{ bs.name }}</span>',
'                          <span style="{{ bs.taskStyle }}">{{ bs.task }}</span>',
'                          <span style="{{ bs.traitStyle }}">{{ bs.trait }}</span>',
'                          <span style="{{ bs.howStyle }}">{{ bs.how }}</span>',
'                        </span>',
'                      </button>',
'                    </sc-for>',
'                  </div>',
...
'                  <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(196px,1fr));gap:6px">',
'                    <sc-for list="{{ findRows }}" as="fd" hint-placeholder-count="24">',
'                      <button onClick="{{ fd.open }}" style="{{ fd.boxStyle }}">',
'                        <div style="display:flex;align-items:baseline;gap:8px">',
'                          <span style="{{ fd.nameStyle }}">{{ fd.name }}</span>',
'                          <span style="{{ fd.tallyStyle }}">{{ fd.tally }}</span>',
'                          <span style="flex:1"></span>',
'                          <span style="{{ fd.tierStyle }}">{{ fd.tier }}</span>',
'                        </div>',
'                        <div style="{{ fd.lookStyle }}">{{ fd.look }}</div>',
'                      </button>',
'                    </sc-for>',
'                  </div>',
'                </div>',
...
'              <div style="padding:26px var(--pad) 0">',
'                <div style="display:flex;flex-wrap:wrap;align-items:baseline;gap:11px;margin-bottom:5px">',
'                  <span style="font:400 11px/1 ' + Q + 'C11' + Q + ';letter-spacing:.18em;color:#E9B341">斗篷人的日誌</span>',
'                  <span style="font:700 22px/1 ' + Q + 'C11' + Q + ';color:#E8E2D6">{{ digLogCount }}</span>',
'                </div>',
'                <div style="font:400 11px/1.7 ' + Q + 'C11' + Q + ';color:#8A8073;margin-bottom:12px">{{ digLogLeft }}</div>',
'                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(148px,1fr));gap:7px">',
'                  <sc-for list="{{ digPages }}" as="pg" hint-placeholder-count="24">',
'                    <div style="{{ pg.style }}">',
'                      <span style="{{ pg.numStyle }}">{{ pg.n }}</span>',
'                      <span style="{{ pg.textStyle }}">{{ pg.text }}</span>',
'                    </div>',
'                  </sc-for>',
'                </div>',
'              </div>',
...
'                  </div>',
'                  <sc-if value="{{ hasVow }}" hint-placeholder-val="{{ true }}">',
'                    <div style="{{ vowBox }}">',
'                      <div style="display:flex;gap:12px;align-items:flex-start;margin-bottom:11px">',
'                        <span style="{{ vowMobArt }}"></span>',
'                        <span style="min-width:0">',
'                          <span style="display:block;font:400 11px/1.6 ' + Q + 'C11' + Q + ';color:#8A8073">{{ vowMobNote }}</span>',
'                          <span style="display:block;font:400 11px/1.6 ' + Q + 'C11' + Q + ';color:#6E665A;margin-top:4px;text-wrap:pretty">{{ vowMobTrait }}</span>',
'                        </span>',
'                      </div>',
'                      <div style="font:500 22px/1.4 ' + Q + 'C11' + Q + ';color:#E9B341;margin-bottom:6px">{{ vowTitle }}</div>',
'                      <div style="font:400 11px/1.7 ' + Q + 'C11' + Q + ';color:#6E665A;margin-bottom:12px;max-width:520px;text-wrap:pretty">{{ vowNote }}</div>',
'                      <div style="display:flex;flex-direction:column;gap:6px">',
'                        <sc-for list="{{ vowPicks }}" as="vw" hint-placeholder-count="5">',
'                          <button onClick="{{ vw.pick }}" style="{{ vw.style }}">',
'                            <span style="{{ vw.markStyle }}">{{ vw.mark }}</span>',
'                            <span style="flex:1;min-width:0">',
'                              <span style="{{ vw.nameStyle }}">{{ vw.name }}</span>',
'                              <span style="{{ vw.howStyle }}">{{ vw.how }}</span>',
'                            </span>',
'                          </button>',
'                        </sc-for>',
'                      </div>',
...
'                  <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(210px,1fr));gap:6px">',
'                    <sc-for list="{{ homeClaims }}" as="hc" hint-placeholder-count="3">',
'                      <div style="{{ hc.boxStyle }}">',
'                        <div style="display:flex;align-items:baseline;gap:9px">',
'                          <span style="{{ hc.nameStyle }}">{{ hc.name }}</span>',
'                          <span style="{{ hc.byStyle }}">{{ hc.by }}</span>',
'                        </div>',
'                        <div style="{{ hc.metaStyle }}">{{ hc.meta }}</div>',
'                      </div>',
'                    </sc-for>',
'                  </div>',
'                </div>',
